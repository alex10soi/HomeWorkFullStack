  ...
  <section class="task">
    ...
    <div class="task_body">
      ...
      <div class="task_result">
        ...
        <output class="task_resultValue">
          <?php echo isset($_SESSION['taskResult_1']) ? $_SESSION['taskResult_1'] : '' ?>
        </output>
      </div>
    </div>
  </section>
  <section class="task">
    ...
    <div class="task_body">
      ...
      <div class="task_result">
        <strong class="result">Result:</strong>
        <output class="task_resultValue">
          <?php echo isset($_SESSION['taskResult_2']) ? $_SESSION['taskResult_2'] : '' ?>
        </output>
      </div>
    </div>
  </section>
    ...
    <div class="task_body">
      ...
      <div class="task_result">
        <div class="task_upload">
          ...
          <span class="error">
            <?php echo isset($_SESSION['taskError_3']) ? $_SESSION['taskError_3'] : ''; ?>
          </span>
        </div>
  ...
  <section class="task">
    ...
    <div class="task_body">
      ...
      <div class="task_result">
        ...
        <div class="myResult">
          <?php echo isset($_SESSION['taskResult_4']) ? $_SESSION['taskResult_4'] : '' ?>
        </div>
      </div>
    </div>
  </section>
  <section class="task">
    ...
    <div class="task_body">
      ...
      <div class="task_result">
        <strong class="result">Result:</strong>
        <output class="task_resultValue">
          <?php echo isset($_SESSION['taskResult_5']) ? $_SESSION['taskResult_5'] : '' ?>
        </output>
      </div>
    </div>
  </section>
  <section class="task">
    ...
    <div class="task_body">
      ...
      <div class="task_result">
        <strong class="result">Result:</strong>
        <output class="task_resultValue">
          <?php echo isset($_SESSION['taskResult_6']) ? $_SESSION['taskResult_6'] : '' ?>
        </output>
      </div>
    </div>
  </section>
  ...
  <section class="task">
    ...
    <div class="task_body">
      ...
      <form action="handler.php" method="post">
        ...
        <div class="task_form">
          <textarea id="value" name="value"><?= isset($_SESSION['task_8_value']) ? $_SESSION['task_8_value'] : '' ?></textarea>
      ...
      <div class="task_result">
        <strong class="result">Result:</strong>
        <output class="task_resultValue">
          <?php echo isset($_SESSION['taskResult_8']) ? $_SESSION['taskResult_8'] : '' ?>
        </output>
      </div>
    </div>
  </section>
